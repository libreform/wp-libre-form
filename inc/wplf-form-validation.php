...
function wplf_validate_additional_fields( $return ) {
  ...
  $custom_fields = array();
  $custom_fields = apply_filters( "wplf_custom_additional_form_fields", $custom_fields, $form );
  $custom_fields = apply_filters( "wplf_{$form->ID}_custom_additional_form_fields", $custom_fields, $form );
  $custom_fields = apply_filters( "wplf_{$form->post_name}_custom_additional_form_fields", $custom_fields, $form );
